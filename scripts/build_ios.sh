...
# Build SuiteSparse
git clone https://github.com/tompaynter03/SuiteSparse_Apple.git
...
#        -DPNG_LIBRARY=`grealpath ../../libtiff-ios/ios/dependencies/lib/libpng.a` \
#        -DPNG_PNG_INCLUDE_DIR=`grealpath ../../libtiff-ios/libpng-1.6.36/arm-apple-darwin64/include` \
#        -DJPEG_LIBRARY=`grealpath ../../libtiff-ios/ios/dependencies/lib/libjpeg.a` \
#        -DJPEG_INCLUDE_DIR=`grealpath ../../libtiff-ios/jpeg-9c/arm-apple-darwin64/include` \
...
unset INC_DIRS
export INC_DIRS=${INC_DIRS}"`grealpath ../../usr`/eigen/include/eigen3\;"
export INC_DIRS=${INC_DIRS}"`grealpath ../../usr`/ceres-solver/include/\;"
export INC_DIRS=${INC_DIRS}"`grealpath ../../usr`/glog/include/\;"
export INC_DIRS=${INC_DIRS}"`grealpath ../../usr`/gflags/include/\;"
export INC_DIRS=${INC_DIRS}"`grealpath ../../usr`/suitesparse/include/suitesparse/\;"
